...
ttestSDQ <- function(data, x) {
  ...
  return(t.test(data %>% 
    ...
    mutate(subscale = x_name) %>%
    select(subscale, statistic, p.value, d))
}
```

```{r Wave 2}
#ASD vs non-ASD differences in parental SDQ scores
bind_rows(ttestSDQ(dat_SDQ, Diff2),
...
```{r Wave 3}
#ASD vs non-ASD differences in parental SDQ scores
bind_rows(ttestSDQ(dat_SDQ, Diff3),
...
```{r Wave 4}
bind_rows(ttestSDQ(dat_SDQ, Diff4),
...
```{r Wave 5}
#ASD vs non-ASD differences in parental SDQ scores
bind_rows(ttestSDQ(dat_SDQ, Diff5),
...
```{r Wave 6}
#ASD vs non-ASD differences in parental SDQ scores
bind_rows(ttestSDQ(dat_SDQ, Diff6),
...
```{r Wave 7}
#ASD vs non-ASD differences in parental SDQ scores
bind_rows(ttestSDQ(dat_SDQ, Diff7),
